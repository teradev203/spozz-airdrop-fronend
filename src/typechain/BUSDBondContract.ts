...
export interface BUSDBondContractInterface extends utils.Interface {
  functions: {
...
export interface BUSDBondContract extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BUSDBondContractInterface;
