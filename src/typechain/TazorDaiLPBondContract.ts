...
export interface TazorDaiLPBondContractInterface extends utils.Interface {
  functions: {
...
export interface TazorDaiLPBondContract extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TazorDaiLPBondContractInterface;
